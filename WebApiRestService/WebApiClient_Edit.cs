...
namespace WebApiRestService
{
	public partial class WebApiClient<T>
	{
        ...
        public async virtual Task<T> EditAsync(T obj)
		{
			...
			return await EditAsync(obj, this.Options.Controller, null, src.Token);
		}
        ...
        public async virtual Task<T> EditAsync(T obj, CancellationToken token)
		{
			...
			return await EditAsync(obj, this.Options.Controller, null, token);
		}
        ...
        public async virtual Task<T> EditAsync(T obj, string action)
		{
			...
			return await EditAsync(obj, this.Options.Controller, action, src.Token);
		}
        ...
        public async virtual Task<T> EditAsync(T obj, string action, CancellationToken token)
		{
			...
			return await EditAsync(obj, this.Options.Controller, action, token);
		}
		...
		protected async virtual Task<T> EditAsync(T obj, string controller, string action, CancellationToken token)
		{
			try
			{
				...
				var response = await this.Client.PutAsync(GenerateUri(controller, action, null), content, token);
