...
namespace WebApiRestService.Authentication
{
    ...
    public class BearerTokenAuthentication : IAuthentication
    {
        ...
        public BearerTokenAuthentication(string username, string password, string tokenUri)
        {
            ...
            if (string.IsNullOrEmpty(tokenUri)) throw new ArgumentNullException("tokenUri");
        ...
        public AuthenticationHeaderValue Authenticate()
        {
            ...
            else
            {
                ...
                string contentBody = this.GetParams().ParseAnonymousObject().ToQueryString().Replace("?", string.Empty);
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    response = client.PostAsync(this.TokenUri, content).Result;
                }
        ...
        {
            return new { username = credential.UserName, password = credential.Password, grant_type = this.grantType };
        }
    }
}
